...
class VerifyCertificatesForm extends FormBase {
  ...
  public function getFormId() {
    return 'cfd_coursework_project_verify_certificates_form';
  }
  ...
  public static function buildVerificationMarkup($qr_code) {
    ...
    $proposal_id = \Drupal::database()->select('coursework_project_qr_code', 'csq')
    ...
    $rows = [
      ...
      [$translator->translate('Project'), $translator->translate('Coursework Project')],
      [$translator->translate('Coursework Project completed'), $proposal->project_title],
    ];
